...
ICHNOS quality sheet. Movebank Data Repository, item `975fdba1-c7dd-4ecd-b3ce-de1fffba4658`.
...
| 95th percentile of gaps | 44.5 h |

## Three quality measures

| Measure | Value | Reading |
|---|---|---|
| Position spikes | 0.030 % | a few isolated outliers |
| Repeated positions | 80.18 % | **a major share of rows carries no new position** |
| Coordinate grain | 5 decimals | acceptable grain |

## What this dataset does not support

- Fix counts as a measure of effort: **80 %** of rows repeat the previous position exactly.
