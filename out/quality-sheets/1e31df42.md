...
ICHNOS quality sheet. Movebank Data Repository, item `1e31df42-edfa-4225-b923-d8b0de83ab20`.
...
| Regularity | 46 % of intervals at the dominant step |
...
| Repeated positions | 0.14 % | nothing notable |
| Coordinate grain | 6 decimals | precision preserved |

## What this dataset does not support

- Comparing distances between individuals without resampling: only **46 %** of intervals are at the dominant step.
