# Data from: Space and resource use by American crow (Corvus brachyrhynchos) in an area endemic for chronic wasting disease

ICHNOS quality sheet. Movebank Data Repository, item `cf532875-a2f2-44f1-ada7-7543c6dbfcdd`.
