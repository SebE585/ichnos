...
ICHNOS quality sheet. Movebank Data Repository, item `861dec63-98e9-407f-8845-1ef03c282ef5`.
...
|---|---|---|
| Position spikes | 0.196 % | **high rate, filter before analysis** |
| Repeated positions | 0.75 % | nothing notable |
| Coordinate grain | 7 decimals | precision preserved |

## What this dataset does not support

- Unfiltered path length: **0.20 %** of triplets show an out-and-back incompatible with that individual's own step.
