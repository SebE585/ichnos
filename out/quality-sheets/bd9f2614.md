...
ICHNOS quality sheet. Movebank Data Repository, item `bd9f2614-11b3-48c3-8251-1aee62c8e650`.
...
| Individuals | 23 |
| Span | 529 days |
| Median cadence | 32 min |
| Dominant cadence | 15 min |
| Regularity | 15 % of intervals at the dominant step |
| 95th percentile of gaps | 3.1 h |

## Three quality measures

| Measure | Value | Reading |
|---|---|---|
| Position spikes | 0.147 % | **high rate, filter before analysis** |
| Repeated positions | 1.74 % | frequent repeats |
