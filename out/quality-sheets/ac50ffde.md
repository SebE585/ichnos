...
ICHNOS quality sheet. Movebank Data Repository, item `ac50ffde-a5ef-4b5c-aa68-e1af46a0016d`.
...
|---|---|---|
| Position spikes | 0.053 % | **high rate, filter before analysis** |
| Repeated positions | 0.07 % | nothing notable |
| Coordinate grain | 7 decimals | precision preserved |

## What this dataset does not support

- Unfiltered path length: **0.05 %** of triplets show an out-and-back incompatible with that individual's own step.
