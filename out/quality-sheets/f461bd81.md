...
ICHNOS quality sheet. Movebank Data Repository, item `f461bd81-eb04-467d-858e-a15c67273728`.
...
| Individuals | 7 |
| Span | 193 days |
| Median cadence | 12.2 h |
| Dominant cadence | 11.4 h |
...
|---|---|---|
| Position spikes | 0.118 % | **high rate, filter before analysis** |
| Repeated positions | 83.22 % | **a major share of rows carries no new position** |
