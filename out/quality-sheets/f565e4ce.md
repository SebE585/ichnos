...
ICHNOS quality sheet. Movebank Data Repository, item `f565e4ce-a459-4bc7-8d3c-11a386901c97`.
...
| | |
|---|---|
| Dominant sensor | sigfox-geolocation |
| Fixes | 4,834 |
| Individuals | 131 |
| Span | 793 days |
| Median cadence | 31 min |
| Dominant cadence | 30 min |
| Regularity | 67 % of intervals at the dominant step |
| 95th percentile of gaps | 23.7 h |

## Three quality measures

| Measure | Value | Reading |
|---|---|---|
| Position spikes | 0.032 % | a few isolated outliers |
| Repeated positions | 0.83 % | nothing notable |
