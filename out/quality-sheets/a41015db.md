...
ICHNOS quality sheet. Movebank Data Repository, item `a41015db-4632-46dc-abed-277b16daf97b`.
...
| Individuals | 17 |
| Span | 1453 days |
| Median cadence | 33 min |
| Dominant cadence | 86 s |
| Regularity | 4 % of intervals at the dominant step |
| 95th percentile of gaps | 3.2 h |

## Three quality measures

| Measure | Value | Reading |
|---|---|---|
| Position spikes | 1.252 % | **high rate, filter before analysis** |
| Repeated positions | 0.55 % | nothing notable |
| Coordinate grain | 15 decimals | precision preserved |

## What this dataset does not support

- Unfiltered path length: **1.25 %** of triplets show an out-and-back incompatible with that individual's own step.
- Comparing distances between individuals without resampling: only **4 %** of intervals are at the dominant step.
