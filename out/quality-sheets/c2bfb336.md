# Data from: Study "Chelonia mydas_Banc_Arguin_2020_2021"

ICHNOS quality sheet. Movebank Data Repository, item `c2bfb336-99ff-402f-b630-9cca68d1e595`.
...
| Individuals | 16 |
| Span | 516 days |
| Median cadence | 46 min |
| Dominant cadence | 8 s |
| Regularity | 1 % of intervals at the dominant step |
| 95th percentile of gaps | 9.5 h |

## Three quality measures

| Measure | Value | Reading |
|---|---|---|
| Position spikes | 0.019 % | a few isolated outliers |
