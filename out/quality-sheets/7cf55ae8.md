...
ICHNOS quality sheet. Movebank Data Repository, item `7cf55ae8-94f6-4c87-a98b-af98366682b8`.
...
| Individuals | 21 |
| Span | 2120 days |
| Median cadence | 13.5 h |
| Dominant cadence | 8.0 h |
| Regularity | 11 % of intervals at the dominant step |
| 95th percentile of gaps | 6.6 j |
...
| Repeated positions | 3.77 % | frequent repeats |
| Coordinate grain | 13 decimals | precision preserved |

## What this dataset does not support

- Comparing distances between individuals without resampling: only **11 %** of intervals are at the dominant step.
