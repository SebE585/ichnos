...
ICHNOS quality sheet. Movebank Data Repository, item `a8224f36-fc72-4b91-bb13-684df2247792`.
...
|---|---|---|
| Position spikes | 0.134 % | **high rate, filter before analysis** |
| Repeated positions | 0.40 % | nothing notable |
