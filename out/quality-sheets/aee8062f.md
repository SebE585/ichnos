...
ICHNOS quality sheet. Movebank Data Repository, item `aee8062f-316b-49d5-a97c-cb04b2d79647`.
...
| Span | 751 days |
| Median cadence | 7 s |
| Dominant cadence | 7 s |
| Regularity | 69 % of intervals at the dominant step |
| 95th percentile of gaps | 27 s |
...
| Repeated positions | 88.04 % | **a major share of rows carries no new position** |
| Coordinate grain | 4 decimals | **coordinates truncated at export, grid of about 89 m** |

## What this dataset does not support

- Any analysis finer than **89 m**: the precision was destroyed before publication and is not recoverable.
- Fix counts as a measure of effort: **88 %** of rows repeat the previous position exactly.
