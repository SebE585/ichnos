...
ICHNOS quality sheet. Movebank Data Repository, item `3c656514-be01-4e6b-ad4a-11625dbb09fc`.
...
| Repeated positions | 62.33 % | **a major share of rows carries no new position** |
| Coordinate grain | 5 decimals | acceptable grain |

## What this dataset does not support

- Fix counts as a measure of effort: **62 %** of rows repeat the previous position exactly.
