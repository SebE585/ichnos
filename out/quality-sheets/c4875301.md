# Data from: Study "Migration routes of the Common Kestrel passing through Guiyang, China"

ICHNOS quality sheet. Movebank Data Repository, item `c4875301-cb7e-4a29-b0b2-2f605dd6fa40`.
...
| | |
|---|---|
| Dominant sensor | gnss |
| Fixes | 831 |
| Individuals | 1 |
| Span | 405 days |
| Median cadence | 6.3 h |
| Dominant cadence | 6.1 h |
| Regularity | 50 % of intervals at the dominant step |
| 95th percentile of gaps | 22.2 h |
...
| Coordinate grain | 9 decimals | precision preserved |
