# Data from: Intra-African movements of the African Cuckoo Cuculus gularis as revealed by satellite telemetry

ICHNOS quality sheet. Movebank Data Repository, item `15cb4cf3-f4a7-468f-bd60-735de02bc219`.
...
| Individuals | 5 |
| Span | 1491 days |
| Median cadence | 63 min |
| Dominant cadence | 29 s |
| Regularity | 0 % of intervals at the dominant step |
| 95th percentile of gaps | 47.8 h |

## Three quality measures

| Measure | Value | Reading |
|---|---|---|
| Position spikes | 0.033 % | a few isolated outliers |
