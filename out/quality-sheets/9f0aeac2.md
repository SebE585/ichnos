# Data from: Foraging and roosting behaviour of the fringe-lipped bat, Trachops cirrhosus, on Barro Colorado Island, Panamá

ICHNOS quality sheet. Movebank Data Repository, item `9f0aeac2-dbd1-43f3-8146-599a1dd9baab`.
...
| Regularity | 70 % of intervals at the dominant step |
| 95th percentile of gaps | 25 min |
...
| Repeated positions | 8.15 % | **a major share of rows carries no new position** |
| Coordinate grain | 14 decimals | precision preserved |

## What this dataset does not support

- Fix counts as a measure of effort: **8 %** of rows repeat the previous position exactly.
