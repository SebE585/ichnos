...
ICHNOS quality sheet. Movebank Data Repository, item `3d43c5d0-e225-4d39-aefd-3cf37e5efd76`.
...
| Dominant cadence | 56 s |
| Regularity | 0 % of intervals at the dominant step |
| 95th percentile of gaps | 2.2 j |

## Three quality measures

| Measure | Value | Reading |
|---|---|---|
| Position spikes | 0.056 % | **high rate, filter before analysis** |
| Repeated positions | 0.94 % | nothing notable |
