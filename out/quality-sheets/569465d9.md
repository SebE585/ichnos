# Data from: Study "GPS tracking of guanay cormorants"

ICHNOS quality sheet. Movebank Data Repository, item `569465d9-a8e9-4b1f-a9bc-00438f80d50b`.
...
|---|---|---|
| Position spikes | 0.020 % | a few isolated outliers |
| Repeated positions | 1.89 % | frequent repeats |
