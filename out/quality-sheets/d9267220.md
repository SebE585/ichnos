...
ICHNOS quality sheet. Movebank Data Repository, item `d9267220-4c7d-4ecd-b994-fba92e425ce8`.
...
| Regularity | 88 % of intervals at the dominant step |
...
| Repeated positions | 94.22 % | **a major share of rows carries no new position** |
| Coordinate grain | 4 decimals | **coordinates truncated at export, grid of about 33 m** |

## What this dataset does not support

- Any analysis finer than **33 m**: the precision was destroyed before publication and is not recoverable.
- Fix counts as a measure of effort: **94 %** of rows repeat the previous position exactly.
