...
ICHNOS quality sheet. Movebank Data Repository, item `115b841d-db72-423f-b853-d71d2cfdecb6`.
...
| Individuals | 14 |
| Span | 1018 days |
| Median cadence | 39 min |
| Dominant cadence | 35 s |
...
| Coordinate grain | 3 decimals | **coordinates truncated at export, grid of about 2 m** |

## What this dataset does not support

- Any analysis finer than **2 m**: the precision was destroyed before publication and is not recoverable.
