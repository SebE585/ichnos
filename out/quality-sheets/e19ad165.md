...
ICHNOS quality sheet. Movebank Data Repository, item `e19ad165-36bb-4c9c-b18f-610fc3eadafd`.
...
| Repeated positions | 25.49 % | **a major share of rows carries no new position** |
| Coordinate grain | 8 decimals | precision preserved |

## What this dataset does not support

- Fix counts as a measure of effort: **25 %** of rows repeat the previous position exactly.
