# Data from: Study "Fishing cat (Prionairulus viverrinus) study in Khao Sam Roi Yot, Thailand"

ICHNOS quality sheet. Movebank Data Repository, item `bc7febf2-d956-409b-944a-0764ae558a51`.
...
| Regularity | 78 % of intervals at the dominant step |
| 95th percentile of gaps | 1.7 h |

## Three quality measures

| Measure | Value | Reading |
|---|---|---|
| Position spikes | 0.072 % | **high rate, filter before analysis** |
