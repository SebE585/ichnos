...
ICHNOS quality sheet. Movebank Data Repository, item `b8fa3914-6ef5-4783-8e16-e0b95aab1bcb`.
...
| Repeated positions | 24.16 % | **a major share of rows carries no new position** |
| Coordinate grain | 8 decimals | precision preserved |

## What this dataset does not support

- Fix counts as a measure of effort: **24 %** of rows repeat the previous position exactly.
