# Data from: Study "Switzerland Lausanne - Long term study on migratory movement of Alpine swifts (Apus melba)"

ICHNOS quality sheet. Movebank Data Repository, item `f32e90c6-d9a1-4fe7-8020-927114731456`.
...
| Repeated positions | 84.00 % | **a major share of rows carries no new position** |
| Coordinate grain | 14 decimals | precision preserved |

## What this dataset does not support

- Fix counts as a measure of effort: **84 %** of rows repeat the previous position exactly.
