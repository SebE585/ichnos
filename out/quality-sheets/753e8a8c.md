# Data from: Study "Bulgaria Sofia - Long term study on migratory movement of Alpine swifts (Apus melba)"

ICHNOS quality sheet. Movebank Data Repository, item `753e8a8c-a125-44c0-8d61-89049cb5ea9b`.
...
| Regularity | 50 % of intervals at the dominant step |
...
| Repeated positions | 80.62 % | **a major share of rows carries no new position** |
...
- Fix counts as a measure of effort: **81 %** of rows repeat the previous position exactly.
- Comparing distances between individuals without resampling: only **50 %** of intervals are at the dominant step.
