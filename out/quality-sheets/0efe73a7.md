...
ICHNOS quality sheet. Movebank Data Repository, item `0efe73a7-b490-4a86-ba35-2517718f6920`.
...
|---|---|---|
| Position spikes | 0.156 % | **high rate, filter before analysis** |
| Repeated positions | 3.19 % | frequent repeats |
| Coordinate grain | 5 decimals | acceptable grain |

## What this dataset does not support

- Unfiltered path length: **0.16 %** of triplets show an out-and-back incompatible with that individual's own step.
