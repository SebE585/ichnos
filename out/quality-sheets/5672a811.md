...
ICHNOS quality sheet. Movebank Data Repository, item `5672a811-db2a-472f-bc42-35dd41ee5ea9`.
...
|---|---|---|
| Position spikes | 0.091 % | **high rate, filter before analysis** |
| Repeated positions | 2.03 % | frequent repeats |
