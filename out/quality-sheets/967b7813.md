...
ICHNOS quality sheet. Movebank Data Repository, item `967b7813-220e-4f60-8415-166d118ac8fa`.
...
| Repeated positions | 35.37 % | **a major share of rows carries no new position** |
| Coordinate grain | 13 decimals | precision preserved |

## What this dataset does not support

- Fix counts as a measure of effort: **35 %** of rows repeat the previous position exactly.
