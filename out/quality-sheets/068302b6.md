...
ICHNOS quality sheet. Movebank Data Repository, item `068302b6-9915-419b-879d-a9aab174a919`.
...
| 95th percentile of gaps | 6 s |

## Three quality measures

| Measure | Value | Reading |
|---|---|---|
| Position spikes | 0.054 % | **high rate, filter before analysis** |
| Repeated positions | 85.74 % | **a major share of rows carries no new position** |
| Coordinate grain | 6 decimals | precision preserved |

## What this dataset does not support

- Fix counts as a measure of effort: **86 %** of rows repeat the previous position exactly.
