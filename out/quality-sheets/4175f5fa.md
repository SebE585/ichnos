...
ICHNOS quality sheet. Movebank Data Repository, item `4175f5fa-e73c-43d9-93f2-f4e718225b9c`.
...
| 95th percentile of gaps | 42.2 h |

## Three quality measures

| Measure | Value | Reading |
|---|---|---|
| Position spikes | 0.310 % | **high rate, filter before analysis** |
...
- Unfiltered path length: **0.31 %** of triplets show an out-and-back incompatible with that individual's own step.
