...
ICHNOS quality sheet. Movebank Data Repository, item `7167d6c5-374a-4aa5-b8da-f9e589f4b438`.
...
| Repeated positions | 85.05 % | **a major share of rows carries no new position** |
| Coordinate grain | 6 decimals | precision preserved |

## What this dataset does not support

- Fix counts as a measure of effort: **85 %** of rows repeat the previous position exactly.
