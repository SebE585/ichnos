...
ICHNOS quality sheet. Movebank Data Repository, item `d52006ff-9c80-4c9e-8170-6569f8018f39`.
...
|---|---|---|
| Position spikes | 0.015 % | a few isolated outliers |
| Repeated positions | 1.81 % | frequent repeats |
