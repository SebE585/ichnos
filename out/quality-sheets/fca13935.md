...
ICHNOS quality sheet. Movebank Data Repository, item `fca13935-d967-491b-a59a-5cf3de80ed2a`.
...
| Individuals | 68 |
| Span | 1402 days |
| Median cadence | 56 min |
| Dominant cadence | 30 s |
| Regularity | 0 % of intervals at the dominant step |
| 95th percentile of gaps | 2.4 j |

## Three quality measures

| Measure | Value | Reading |
|---|---|---|
| Position spikes | 0.085 % | **high rate, filter before analysis** |
| Repeated positions | 3.64 % | frequent repeats |
| Coordinate grain | 3 decimals | **coordinates truncated at export, grid of about 3 m** |

## What this dataset does not support

- Any analysis finer than **3 m**: the precision was destroyed before publication and is not recoverable.
