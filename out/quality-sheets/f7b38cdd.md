...
ICHNOS quality sheet. Movebank Data Repository, item `f7b38cdd-b028-4889-8163-694c86df7dec`.
...
| Repeated positions | 5.40 % | **a major share of rows carries no new position** |
| Coordinate grain | 8 decimals | precision preserved |

## What this dataset does not support

- Fix counts as a measure of effort: **5 %** of rows repeat the previous position exactly.
