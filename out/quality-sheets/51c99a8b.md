# Data from: An integrated approach to modeling grazing pressure in pastoral systems: the case of the Logone Floodplain (Cameroon)

ICHNOS quality sheet. Movebank Data Repository, item `51c99a8b-2819-4fcf-8d30-c8d44b72489e`.
...
| Repeated positions | 16.73 % | **a major share of rows carries no new position** |
| Coordinate grain | 7 decimals | precision preserved |

## What this dataset does not support

- Fix counts as a measure of effort: **17 %** of rows repeat the previous position exactly.
