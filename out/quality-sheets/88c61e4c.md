...
ICHNOS quality sheet. Movebank Data Repository, item `88c61e4c-e277-46ae-9762-2e2d9efbf451`.
...
| Individuals | 2 |
| Span | 2080 days |
| Median cadence | 23 min |
| Dominant cadence | 6 min |
| Regularity | 9 % of intervals at the dominant step |
| 95th percentile of gaps | 36.4 h |

## Three quality measures

| Measure | Value | Reading |
|---|---|---|
| Position spikes | 0.089 % | **high rate, filter before analysis** |
| Repeated positions | 5.10 % | **a major share of rows carries no new position** |
...
- Comparing distances between individuals without resampling: only **9 %** of intervals are at the dominant step.
