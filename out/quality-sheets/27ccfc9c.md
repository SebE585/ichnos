...
ICHNOS quality sheet. Movebank Data Repository, item `27ccfc9c-6102-4eaa-b074-7fc3752dca7e`.
...
| Repeated positions | 78.46 % | **a major share of rows carries no new position** |
| Coordinate grain | 5 decimals | acceptable grain |

## What this dataset does not support

- Fix counts as a measure of effort: **78 %** of rows repeat the previous position exactly.
